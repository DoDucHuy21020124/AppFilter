...
# examples
example_1_dir = str(root/ "inputs/images/filters/eye_glasses.png")
example_2_dir = str(root / "inputs/images/filters/le_hai_lam.png")
example_3_dir = str(root / "inputs/images/filters/leonardo_dicarpio.jpg")
