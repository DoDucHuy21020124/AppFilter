...
from src.filters.utils.utils_filter import *
from src.filters.filter_images.filter_glasses_image import FilterGlassesImage
...
if __name__ == '__main__':
    ...
    from src.model.filter_resnet import FilterResnet

    print(root)

    config_path = os.path.join(str(root), 'configs/filters/filter_video/filter_glasses_video')
    image_folder = os.path.join(str(root), 'inputs/images/filters')
    print(image_folder)
    output_folder = os.path.join(str(root), 'outputs/videos/')
    input_path = os.path.join(str(root), 'inputs/videos/test_video.mp4')
    pretrained_weight_path = os.path.join(str(root), 'inputs/pretrained_weights/weight_resnet50_1.pt')
    ...
    def main(cfg: DictConfig):
        ...
        filter_glasses_video = FilterGlassesVideo(output_folder = output_folder,
            filter_image = FilterGlassesImage(model = FilterResnet(model_name= 'resnet50', pretrained_weight_path = pretrained_weight_path),
